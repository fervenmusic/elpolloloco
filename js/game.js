...
/**
 * Starts the game when clicking on the game start button.
 */
function startGame() {
	showLoadingscreen();
	hideStartScreen();
...
function initWorld() {
    ...
    // You may also want to add an event listener to handle resizing
 ...
 * @param {string} time interval time in ms
 */
 ...
 * @param {Boolean} statusFullscreen status of the fullscreen mode
 */
...
function playBackgroundMusic() {
    const backgroundMusic = world.AUDIO.background_music;
...
function detectMobileDevice() {
    ...
    const isMobile = /iphone|ipad|ipod|android|blackberry|windows phone|iemobile|wpdesktop|opera mini|kindle|mobile|tablet/i.test(userAgent);
